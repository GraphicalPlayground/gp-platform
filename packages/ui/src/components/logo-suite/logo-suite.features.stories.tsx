...
Marquee.play = async ({ canvasElement }: Parameters<PlayFunction>[0]) => {
...
export const WithRasterLogos = () => (
  <LogoSuite>
    <LogoSuite.Heading visuallyHidden>Heading</LogoSuite.Heading>
    <LogoSuite.Logobar>
      <Image alt='Uber' src={uberLogo.src} />
      <Image alt='Vercel' src={vercelLogo.src} />
      <Image alt='Shopify' src={shopifyLogo.src} />
      <Image alt='Pinterest' src={pinterestLogo.src} />
      <Image alt='Twilio' src={twilioLogo.src} />
    </LogoSuite.Logobar>
  </LogoSuite>
);
