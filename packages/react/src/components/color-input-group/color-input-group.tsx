...
const ColorInputGroupPrefix = ({ children, className, ...props }: ColorInputGroupPrefixProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.prefix, className)} data-slot='color-input-group-prefix' {...props}>
      {children}
    </div>
  );
};
...
const ColorInputGroupSuffix = ({ children, className, ...props }: ColorInputGroupSuffixProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.suffix, className)} data-slot='color-input-group-suffix' {...props}>
      {children}
    </div>
  );
};
