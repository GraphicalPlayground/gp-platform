        ...
        <Popover.Trigger aria-label='Popover trigger'>
          <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col gap-0'>
              ...
              <p className='text-xs leading-none text-muted'>zoe@graphical-playground.com</p>
            </div>
          </div>
        </Popover.Trigger>
              ...
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3'>
                  ...
                  <div className='flex h-full flex-col items-start justify-center'>
                    ...
                    <span className='text-sm leading-4 font-normal tracking-tight text-muted'>@zoe</span>
                  </div>
                </div>
                <Button
...
const SpringAnimationTemplate = (props: Popover['ContentProps']) => (
  <div className='flex flex-col items-center gap-8 p-8'>
    ...
    <p className='text-sm text-muted'>The popover now uses a spring easing function for a more dynamic feel</p>
    ...
    <div className='space-y-1 text-center text-xs text-muted'>
      ...
      <code className='rounded bg-surface px-2 py-1 text-xs'>
        data-[entering]:animate-in data-[entering]:zoom-in-90 data-[entering]:fade-in-0 data-[entering]:ease-spring
...
const CardWithHelptextTemplate = (props: Popover['ContentProps']) => (
  <Card className='w-[400px]'>
          ...
          <Popover.Content {...props} className='max-w-[200px]' placement='right'>
            <Popover.Dialog>
              ...
              <p className='text-sm text-muted'>
                This is a helptext popover that appears on top of the card surface. It provides additional context or
                information about the card title.
              </p>
            </Popover.Dialog>
          </Popover.Content>
        </Popover>
    ...
    <Card.Content>
      <p className='text-sm'>
        The popover help icon is positioned right after the title, allowing users to access additional information
