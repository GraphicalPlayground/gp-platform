...
import type { PopoverVariants } from '@gp/styles';
import type { ComponentPropsWithRef, ReactNode } from 'react';

import { popoverVariants } from '@gp/styles';
...
const PopoverRoot = ({ children, ...props }: ComponentPropsWithRef<typeof PopoverTriggerPrimitive>) => {
...
const PopoverDialog = ({ children, className, ...props }: PopoverDialogProps) => {
  ...
  return (
    <DialogPrimitive data-slot='popover-dialog' {...props} className={composeSlotClassName(slots?.dialog, className)}>
      {children}
    </DialogPrimitive>
  );
};
 ...
 * Popover Trigger
 * -----------------------------------------------------------------------------------------------*/
interface PopoverTriggerProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const PopoverHeading = ({ children, className, ...props }: PopoverHeadingProps) => {
  ...
  return (
    <HeadingPrimitive slot='title' {...props} className={composeSlotClassName(slots?.heading, className)}>
      {children}
    </HeadingPrimitive>
  );
};
