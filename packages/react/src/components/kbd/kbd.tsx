...
import type { KbdVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { kbdVariants } from '@gp/styles';
...
const KbdAbbr = ({ className, keyValue, ...props }: KbdAbbrProps) => {
  ...
  return (
    <abbr className={composeSlotClassName(slots?.abbr, className)} title={kbdKeysLabelMap[keyValue]} {...props}>
      {kbdKeysMap[keyValue]}
    </abbr>
  );
};
