...
const DateInputGroupPrefix = ({ children, className, ...props }: DateInputGroupPrefixProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.prefix, className)} data-slot='date-input-group-prefix' {...props}>
      {children}
    </div>
  );
};
...
const DateInputGroupSuffix = ({ children, className, ...props }: DateInputGroupSuffixProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.suffix, className)} data-slot='date-input-group-suffix' {...props}>
      {children}
    </div>
  );
};
