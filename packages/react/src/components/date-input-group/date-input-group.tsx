...
import type { DateInputGroupVariants } from '@gp/styles';
...
import { dateInputGroupVariants } from '@gp/styles';
import React, { createContext, useContext } from 'react';
import { DateInput as DateInputPrimitive, DateSegment as DateSegmentPrimitive } from 'react-aria-components/DateField';
...
const DateInputGroupRoot = ({ children, className, fullWidth, variant, ...props }: DateInputGroupRootProps) => {
  const slots = React.useMemo(() => dateInputGroupVariants({ fullWidth, variant }), [fullWidth, variant]);
 ...
 * -----------------------------------------------------------------------------------------------*/
interface DateInputGroupPrefixProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const DateInputGroupPrefix = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  className,
  ...props
}: DateInputGroupPrefixProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof DateInputGroupPrefixProps<E>>) => {
...
interface DateInputGroupInputProps
  extends DateInputPrimitiveProps, Partial<Omit<TimeInputPrimitiveProps, keyof DateInputPrimitiveProps>> {}
...
interface DateInputGroupSegmentProps
  extends DateSegmentPrimitiveProps, Partial<Omit<TimeSegmentPrimitiveProps, keyof DateSegmentPrimitiveProps>> {
  className?: string;
}
 ...
 * -----------------------------------------------------------------------------------------------*/
interface DateInputGroupInputContainerProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
 ...
 * -----------------------------------------------------------------------------------------------*/
interface DateInputGroupSuffixProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const DateInputGroupSuffix = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  className,
  ...props
}: DateInputGroupSuffixProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof DateInputGroupSuffixProps<E>>) => {
  const { slots } = useContext(DateInputGroupContext);
