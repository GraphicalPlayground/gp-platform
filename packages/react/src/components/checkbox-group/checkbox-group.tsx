...
import type { CheckboxGroupVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { checkboxGroupVariants } from '@gp/styles';
...
const CheckboxGroup = ({ children, className, variant, ...props }: CheckboxGroupProps) => {
  ...
  return (
    <CheckboxGroupContext.Provider value={{ variant }}>
      <CheckboxGroupPrimitive className={composeTwRenderProps(className, styles)} data-slot='checkbox-group' {...props}>
