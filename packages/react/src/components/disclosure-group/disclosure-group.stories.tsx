    ...
    <div className='w-full max-w-md'>
      <div className='flex flex-col gap-4 rounded-3xl bg-surface p-4 shadow-surface'>
        <DisclosureGroup {...props} expandedKeys={expandedKeys} onExpandedChange={setExpandedKeys}>
          <Disclosure aria-label='Preview GP Native' id='preview'>
            <Disclosure.Heading>
              <Button
                slot='trigger'
            ...
            <Disclosure.Content>
              <Disclosure.Body className='mx-2 flex flex-col items-center gap-2 p-4 text-center'>
                <p className='text-sm text-muted'>
                  Scan this QR code with your camera app to preview the GP native components.
                </p>
                <img
                  alt='Expo Go QR Code'
          ...
          <Disclosure id='download'>
            <Disclosure.Heading aria-label='Download GP Native'>
              <Button
                slot='trigger'
    ...
    <div className='w-full max-w-md'>
      <div className='flex flex-col gap-4 rounded-3xl bg-surface p-4 shadow-surface'>
        <div className='mb-2 flex items-center justify-between'>
          <h3 className='text-lg font-semibold'>GP Native</h3>
