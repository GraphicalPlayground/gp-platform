...
const Template = ({ color, size }: Avatar['RootProps']) => (
  <div className='flex items-start gap-4'>
    ...
    <div className='flex flex-col gap-4'>
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image alt='Junior Garcia' src='https://img.heroui.chat/image/avatar?w=400&h=400&u=4' />
        <Avatar.Fallback delayMs={600}>JG</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt='Junior Garcia' src='https://img.heroui.chat/image/avatar?w=400&h=400&u=5' />
        <Avatar.Fallback delayMs={600}>JG</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
    ...
    <div className='flex flex-col gap-4'>
      <Avatar color={color} size={size}>
        <Avatar.Image alt='Red' src='https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/red.jpg' />
        <Avatar.Fallback>R</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt='Orange' src='https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/orange.jpg' />
        <Avatar.Fallback>O</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt='Green' src='https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/green.jpg' />
        <Avatar.Fallback>G</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt='White' src='https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/white.jpg' />
        <Avatar.Fallback>W</Avatar.Fallback>
      </Avatar>
      <Avatar color={color} size={size}>
        <Avatar.Image alt='Black' src='https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/black.jpg' />
      ...
      {variants.map((variant) => (
        <div key={variant.label} className='flex items-center gap-3'>
          ...
          {colors.map((color, colorIndex) => (
            <div key={color} className='flex w-20 shrink-0 items-center justify-center'>
              <Avatar {...props} color={color} variant={variant.type.includes('soft') ? 'soft' : undefined}>
                {variant.type === 'img' ? (
                  <>
                    <Avatar.Image
                      alt={`Avatar ${color}`}
