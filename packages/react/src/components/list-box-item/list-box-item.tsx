...
import type { ListBoxItemVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';
import type { ListBoxItemRenderProps } from 'react-aria-components/ListBox';

import { listboxItemVariants } from '@gp/styles';
 ...
 * -----------------------------------------------------------------------------------------------*/
interface ListBoxItemIndicatorProps<E extends keyof React.JSX.IntrinsicElements = 'span'> extends DOMRenderProps<
  E,
  undefined
> {
...
const ListBoxItemIndicator = <E extends keyof React.JSX.IntrinsicElements = 'span'>({
  ...
  className,
  ...props
}: ListBoxItemIndicatorProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof ListBoxItemIndicatorProps<E>>) => {
