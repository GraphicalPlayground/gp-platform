...
const ToastIndicator = ({ children, className, variant, ...rest }: ToastIndicatorProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.indicator, className)} data-slot='toast-indicator' {...rest}>
      {children ?? getDefaultIcon()}
    </div>
  );
};

ToastIndicator.displayName = 'GP.ToastIndicator';
...
ToastTitle.displayName = 'GP.ToastTitle';
...
ToastDescription.displayName = 'GP.ToastDescription';
...
ToastCloseButton.displayName = 'GP.ToastCloseButton';
...
ToastActionButton.displayName = 'GP.ToastActionButton';
...
ToastProvider.displayName = 'GP.ToastProvider';
