...
import type { GPToastOptions } from './toast-queue';
...
interface ToastStoryProps extends Omit<GPToastOptions, 'variant'> {
  placement?: Placement;
}
        ...
        <Button
          ...
          onPress={() => {
            toast('You have been invited to join a team', {
              ...
              description: 'Bob sent you an invitation to join GP team',
        ...
        <Button
          ...
          onPress={() =>
            toast.success('You have upgraded your plan', {
              ...
              description: 'You can continue using GP Chat'
            })
          }
        >
          Success toast
