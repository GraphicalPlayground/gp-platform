...
const RadioControl = ({ children, className, ...props }: RadioControlProps) => {
  ...
  return (
    <span className={composeSlotClassName(slots?.control, className)} data-slot='radio-control' {...props}>
      {children}
    </span>
  );
};
...
const RadioContent = ({ children, className, ...props }: RadioContentProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.content, className)} data-slot='radio-content' {...props}>
      {children}
    </div>
  );
};
