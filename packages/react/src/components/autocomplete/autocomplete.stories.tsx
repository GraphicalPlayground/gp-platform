      ...
      <div className='w-full space-y-4'>
        ...
        <div className='space-y-2 rounded-xl border border-border p-4'>
          ...
          <div className='space-y-1 text-sm text-muted'>
            ...
            {!selectedItem && <p className='text-muted'>No selection (click clear to see the callback)</p>}
          </div>
        </div>
      </div>
    );
  ...
  render: () => {
    ...
    return (
      <Form className='flex w-[256px] flex-col gap-4' onSubmit={onSubmit}>
        <Autocomplete isRequired className='w-full' name='state' placeholder='Select one' selectionMode='single'>
          <Label>State</Label>
          <Autocomplete.Trigger>
            <Autocomplete.Value />
            <Autocomplete.ClearButton />
...
export const AsynchronousFiltering: Story = {
  render: () => {
    ...
    return (
      <Autocomplete allowsEmptyCollection className='w-[256px]' placeholder='Search...' selectionMode='single'>
    ...
    const users = [
      {
        id: '1',
        name: 'Bob',
        email: 'bob@graphical-playground.com',
      ...
      },
      {
        id: '2',
        name: 'Fred',
        email: 'fred@graphical-playground.com',
      ...
      },
      {
        id: '3',
        name: 'Martha',
        email: 'martha@graphical-playground.com',
      ...
      },
      {
        id: '4',
        name: 'John',
        email: 'john@graphical-playground.com',
      ...
      },
      {
        id: '5',
        name: 'Jane',
        email: 'jane@graphical-playground.com',
      ...
      >
        ...
        <Autocomplete.Popover>
          <Autocomplete.Filter filter={customFilter}>
            ...
            <ListBox renderEmptyState={() => <EmptyState>{isLoading ? 'Searching...' : 'No cities found'}</EmptyState>}>
              {allCities.map((city) => (
