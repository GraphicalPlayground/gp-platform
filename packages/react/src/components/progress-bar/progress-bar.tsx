...
import type { ProgressBarVariants } from '@gp/styles';
import type { ComponentPropsWithRef, ReactNode } from 'react';
import type { ProgressBarRenderProps } from 'react-aria-components/ProgressBar';

import { progressBarVariants } from '@gp/styles';
...
const ProgressBarRoot = ({ children, className, color, size, ...props }: ProgressBarRootProps) => {
  ...
  return (
    <ProgressBarPrimitive data-slot='progress-bar' {...props} className={composeTwRenderProps(className, slots.base())}>
      {(values) => (
...
ProgressBarRoot.displayName = 'GPlayd.ProgressBar';

/* -------------------------------------------------------------------------------------------------
 * ProgressBar Output
 * -----------------------------------------------------------------------------------------------*/
interface ProgressBarOutputProps<E extends keyof React.JSX.IntrinsicElements = 'span'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const ProgressBarOutput = <E extends keyof React.JSX.IntrinsicElements = 'span'>({
  ...
  className,
  ...props
}: ProgressBarOutputProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof ProgressBarOutputProps<E>>) => {
...
ProgressBarOutput.displayName = 'GPlayd.ProgressBar.Output';

/* -------------------------------------------------------------------------------------------------
 * ProgressBar Track
 * -----------------------------------------------------------------------------------------------*/
interface ProgressBarTrackProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const ProgressBarTrack = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  className,
  ...props
}: ProgressBarTrackProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof ProgressBarTrackProps<E>>) => {
...
ProgressBarTrack.displayName = 'GPlayd.ProgressBar.Track';

/* -------------------------------------------------------------------------------------------------
 * ProgressBar Fill
 * -----------------------------------------------------------------------------------------------*/
interface ProgressBarFillProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
ProgressBarFill.displayName = 'GPlayd.ProgressBar.Fill';
