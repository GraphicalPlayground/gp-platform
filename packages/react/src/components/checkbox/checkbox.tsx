...
const CheckboxControl = ({ children, className, ...props }: CheckboxControlProps) => {
  ...
  return (
    <span className={composeSlotClassName(slots?.control, className)} data-slot='checkbox-control' {...props}>
      {children}
    </span>
  );
};
...
const CheckboxContent = ({ children, className, ...props }: CheckboxContentProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.content, className)} data-slot='checkbox-content' {...props}>
      {children}
    </div>
  );
};
