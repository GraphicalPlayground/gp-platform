      ...
      {({ isSelected }) => (
        <>
          ...
          <Checkbox.Content>
            ...
            <Description>{isSelected ? 'Thank you for accepting' : 'Please read and accept the terms'}</Description>
          </Checkbox.Content>
        </>
      )}
    </Checkbox>
  ...
  render: () => (
    <div className='flex flex-col gap-6 px-4'>
      <div className='flex flex-col gap-3'>
        ...
        <Checkbox className="[&_[data-slot='checkbox-default-indicator--checkmark']]:size-2" id='small-rounded'>
      ...
      <div className='flex flex-col gap-3'>
        <Checkbox className="[&_[data-slot='checkbox-default-indicator--checkmark']]:size-4" id='xl-rounded'>
