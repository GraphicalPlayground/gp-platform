...
CalendarYearPickerTrigger.displayName = 'GP.CalendarYearPicker.Trigger';

/* -------------------------------------------------------------------------------------------------
 * CalendarYearPickerTriggerHeading
 * -----------------------------------------------------------------------------------------------*/
const CalendarYearPickerTriggerHeading = ({ children, className, ...props }: CalendarYearPickerTriggerHeadingProps) => {
...
CalendarYearPickerTriggerHeading.displayName = 'GP.CalendarYearPicker.TriggerHeading';
...
const CalendarYearPickerTriggerIndicator = ({
  ...
  return (
    <span
      ...
      {...props}
    >
      {typeof children === 'function' ? children({ monthYear, ...values }) : children || <IconChevronRight />}
    </span>
  );
};

CalendarYearPickerTriggerIndicator.displayName = 'GP.CalendarYearPicker.TriggerIndicator';
...
const CalendarYearPickerGrid = ({ children, className, onKeyDown, ...props }: CalendarYearPickerGridProps) => {
...
CalendarYearPickerGrid.displayName = 'GP.CalendarYearPicker.Grid';
...
CalendarYearPickerGridBody.displayName = 'GP.CalendarYearPicker.GridBody';
...
CalendarYearPickerCell.displayName = 'GP.CalendarYearPicker.Cell';
