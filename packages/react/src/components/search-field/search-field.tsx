...
import type { SearchFieldVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { searchFieldVariants } from '@gp/styles';
...
const SearchFieldRoot = ({ children, className, fullWidth, variant, ...props }: SearchFieldRootProps) => {
  const slots = React.useMemo(() => searchFieldVariants({ fullWidth, variant }), [fullWidth, variant]);
 ...
 * -----------------------------------------------------------------------------------------------*/
interface SearchFieldSearchIconProps<E extends keyof React.JSX.IntrinsicElements = 'svg'> extends DOMRenderProps<
  E,
  undefined
> {
...
const SearchFieldSearchIcon = <E extends keyof React.JSX.IntrinsicElements = 'svg'>({
  ...
  className,
  ...props
}: SearchFieldSearchIconProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof SearchFieldSearchIconProps<E>>) => {
  const { slots } = useContext(SearchFieldContext);
