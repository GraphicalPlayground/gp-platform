...
import type { SurfaceVariants } from '@gp/styles';
import type { ReactNode } from 'react';

import { surfaceVariants } from '@gp/styles';
...
const SurfaceRoot = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <SurfaceContext value={{ variant }}>
      <dom.div className={surfaceVariants({ variant, className })} data-slot='surface' {...(rest as any)}>
        {children}
      </dom.div>
    </SurfaceContext>
  );
