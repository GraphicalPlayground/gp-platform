  ...
  render: () => (
    <div className='flex flex-col gap-4'>
      <div className='flex flex-col gap-2'>
        ...
        <Surface className='flex min-w-[320px] flex-col gap-3 rounded-3xl border p-6' variant='transparent'>
          ...
          <p className='text-sm text-muted'>This is a default surface variant. It uses bg-surface styling.</p>
        </Surface>
      </div>
      <div className='flex flex-col gap-2'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <Surface className='flex min-w-[320px] flex-col gap-3 rounded-3xl p-6' variant='tertiary'>
          ...
          <p className='text-sm text-muted'>This is a tertiary surface variant. It uses bg-surface-tertiary styling.</p>
        </Surface>
      </div>
    </div>
  )
