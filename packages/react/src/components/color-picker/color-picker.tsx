...
const ColorPickerPopover = ({ children, className, placement = 'bottom left', ...props }: ColorPickerPopoverProps) => {
  const { slots } = useContext(ColorPickerContext);
