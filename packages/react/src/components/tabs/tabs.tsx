...
import type { TabsVariants } from '@gp/styles';
import type { ComponentPropsWithRef, ReactNode } from 'react';

import { tabsVariants } from '@gp/styles';
...
const TabsRoot = ({ children, className, orientation = 'horizontal', variant, ...props }: TabsRootProps) => {
 ...
 * Tabs List Container
 * -----------------------------------------------------------------------------------------------*/
interface TabListContainerProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const TabListContainer = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  className,
  ...props
}: TabListContainerProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof TabListContainerProps<E>>) => {
