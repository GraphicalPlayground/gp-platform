    ...
    <div className='w-[600px]'>
      <Tabs {...args} orientation='vertical'>
        ...
        <Tabs.Panel className='px-4' id='security'>
          ...
          <p className='text-sm text-gray-600'>Configure two-factor authentication and password settings.</p>
        </Tabs.Panel>
        ...
        <Tabs.Panel className='px-4' id='billing'>
          ...
          <p className='text-sm text-gray-600'>View and manage your subscription and payment methods.</p>
        </Tabs.Panel>
      </Tabs>
    </div>
  );
...
const Showcase1Template = (args: Story['args']) => {
  ...
  const zoomImgMap: Record<number | 'macro', string> = {
    [200]: 'https://www.apple.com/v/iphone-17-pro/a/images/overview/cameras/zoom/200mm__c8kya18imsqe_large_2x.jpg',
    [100]: 'https://www.apple.com/v/iphone-17-pro/a/images/overview/cameras/zoom/100mm__cykxcenbhvue_large_2x.jpg',
    ...
    ['macro']: 'https://www.apple.com/v/iphone-17-pro/a/images/overview/cameras/zoom/macro__bb7oud7ri2o2_large_2x.jpg'
  };
      ...
      <div className='flex flex-col items-center'>
        ...
        <Tabs {...args} defaultSelectedKey={DEFAULT_ZOOM} onSelectionChange={setSelectedZoom}>
          <Tabs.ListContainer className='scrollbar-hide my-4 w-full max-w-full overflow-x-auto sm:my-6'>
            ...
            >
              {zoomLevels.map((zoom) => (
                <Tabs.Tab key={zoom} className={zoom === 'macro' ? 'capitalize' : ''} id={zoom.toString()}>
                  {zoom} {zoom === 'macro' ? '' : 'mm'}
