...
const SwitchControl = ({ children, className, ...props }: SwitchControlProps) => {
  ...
  return (
    <span className={composeSlotClassName(slots?.control, className)} data-slot='switch-control' {...props}>
      {children}
    </span>
  );
};
...
const SwitchThumb = ({ children, className, ...props }: SwitchThumbProps) => {
  ...
  return (
    <span className={composeSlotClassName(slots?.thumb, className)} data-slot='switch-thumb' {...props}>
      {children}
    </span>
  );
};
...
const SwitchIcon = ({ children, className, ...props }: SwitchIconProps) => {
  ...
  return (
    <span className={composeSlotClassName(slots?.icon, className)} data-slot='switch-icon' {...props}>
      {children}
    </span>
  );
};
...
const SwitchContent = ({ children, className, ...props }: SwitchContentProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.content, className)} data-slot='switch-content' {...props}>
      {children}
    </div>
  );
};
