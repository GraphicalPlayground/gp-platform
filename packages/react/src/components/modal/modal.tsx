...
import type { ModalVariants } from '@gp/styles';
...
import { modalVariants } from '@gp/styles';
...
const ModalRoot = ({ children, state, ...props }: ModalRootProps) => {
  const modalContext = useMemo<ModalContext>(() => ({ slots: modalVariants(), placement: undefined }), []);
...
const ModalContainer = ({ children, className, placement = 'auto', scroll, size, ...props }: ModalContainerProps) => {
  const { slots: contextSlots } = useContext(ModalContext);
...
const ModalHeader = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.header, className)} data-slot='modal-header' {...(props as any)}>
      {children}
    </dom.div>
  );
};
...
const ModalBody = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.body, className)} data-slot='modal-body' {...(props as any)}>
      {children}
    </dom.div>
  );
};
...
const ModalFooter = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.footer, className)} data-slot='modal-footer' {...(props as any)}>
      {children}
    </dom.div>
  );
};
...
const ModalIcon = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.icon, className)} data-slot='modal-icon' {...(props as any)}>
      {children}
    </dom.div>
  );
};
