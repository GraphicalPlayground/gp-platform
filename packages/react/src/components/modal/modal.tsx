...
const ModalBackdrop = ({ children, className, isDismissable = true, variant, ...props }: ModalBackdropProps) => {
...
const ModalHeader = ({ children, className, ...props }: ModalHeaderProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.header, className)} data-slot='modal-header' {...props}>
      {children}
    </div>
  );
};
...
const ModalFooter = ({ children, className, ...props }: ModalFooterProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.footer, className)} data-slot='modal-footer' {...props}>
      {children}
    </div>
  );
};
