        ...
        <Modal.Container>
          <Modal.Dialog className='sm:max-w-[360px]'>
            ...
            <Modal.Header>
              ...
              <Modal.Heading>Welcome to GPlayd</Modal.Heading>
            </Modal.Header>
            <Modal.Body>
              <p>
            ...
            <Modal.Container placement={placement}>
              <Modal.Dialog className='sm:max-w-[360px]'>
                ...
                <Modal.Header>
                  ...
                  <Modal.Heading>Placement: {placement.charAt(0).toUpperCase() + placement.slice(1)}</Modal.Heading>
                </Modal.Header>
                <Modal.Body>
                  <p>
                    This modal uses the <code>{placement}</code> placement option. Try different placements to see how
                    the modal positions itself on the screen.
                  </p>
                </Modal.Body>
                <Modal.Footer>
                  <Button className='w-full' slot='close'>
            ...
            <Modal.Container>
              <Modal.Dialog className='sm:max-w-[360px]'>
                ...
                <Modal.Header>
                  ...
                  <Modal.Heading>Backdrop: {variant.charAt(0).toUpperCase() + variant.slice(1)}</Modal.Heading>
                </Modal.Header>
                <Modal.Body>
                  <p>
                    This modal uses the <code>{variant}</code> backdrop variant. Compare the different visual effects:
                    opaque provides full opacity, blur adds a backdrop filter, and transparent removes the background.
                  </p>
                </Modal.Body>
                <Modal.Footer>
                  <Button className='w-full' slot='close'>
              ...
              <Modal.Dialog>
                ...
                <Modal.Body>
                  <p>
                    {size === 'cover' ? (
                      <>
                        This modal uses the <code>cover</code> size variant. It spans the full screen with margins: 16px
                        on mobile and 40px on desktop. Maintains rounded corners and standard padding. Perfect for
                        cover-style content that needs maximum width while preserving modal aesthetics.
                      </>
                    ) : size === 'full' ? (
                      <>
                        This modal uses the <code>full</code> size variant. It occupies the entire viewport without any
                        margins, rounded corners, or shadows, creating a true fullscreen experience. Ideal for immersive
                        content or full-page interactions.
                      </>
                    ) : (
                      <>
                        This modal uses the <code>{size}</code> size variant. On mobile devices, all sizes adapt to near
                        full-width for optimal viewing. On desktop, each size provides a different maximum width to suit
    ...
    >
      <Modal.Container>
        <Modal.Dialog className='sm:max-w-[360px]'>
          ...
          <Modal.Body>
            <p>
              This backdrop features a sophisticated gradient that transitions from a dark color at the bottom to
              complete transparency at the top, combined with a smooth blur effect. The gradient automatically adapts
              its intensity for optimal contrast in both light and dark modes.
            </p>
          </Modal.Body>
  ...
  <div className='flex max-w-sm flex-col gap-6'>
    <div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-muted'>
        Controls whether the modal can be dismissed by clicking the overlay backdrop. Defaults to <code>true</code>. Set
        to <code>false</code> to require explicit close action.
      </p>
      <Modal>
        <Button variant='secondary'>Open Modal</Button>
          ...
          <Modal.Container>
            <Modal.Dialog className='sm:max-w-[360px]'>
              ...
              <Modal.Header>
                ...
                <p className='text-sm leading-5 text-muted'>Clicking the backdrop won't close this modal</p>
              </Modal.Header>
              <Modal.Body>
                <p>
                  Try clicking outside this modal on the overlay - it won't close. You must use the close button or
    ...
    <div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-muted'>
        Controls whether the ESC key can dismiss the modal. When set to <code>true</code>, the ESC key will be disabled
        and users must use explicit close actions.
      </p>
      <Modal>
        <Button variant='secondary'>Open Modal</Button>
        <Modal.Backdrop isKeyboardDismissDisabled>
          <Modal.Container>
            <Modal.Dialog className='sm:max-w-[360px]'>
              ...
              <Modal.Body>
                <p>
                  Press ESC - nothing happens. You must use the close button or click the overlay backdrop to dismiss
                  this modal.
                </p>
              </Modal.Body>
              <Modal.Footer>
...
export const CloseMethods = () => (
  <div className='flex max-w-2xl flex-col gap-8'>
    <div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-muted'>
        The simplest way to close a modal. Add <code>slot="close"</code> to any Button component within the modal. When
        clicked, it will automatically close the modal.
      </p>
      <Modal>
        <Button variant='secondary'>Open Modal</Button>
        <Modal.Backdrop>
          <Modal.Container>
            <Modal.Dialog className='sm:max-w-[360px]'>
              ...
              <Modal.Body>
                <p>
                  Click either button below - both have <code>slot="close"</code> and will close the modal
                  automatically.
                </p>
              </Modal.Body>
              <Modal.Footer>
    ...
    <div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-muted'>
        Access the <code>close</code> method from the Dialog's render props. This gives you full control over when and
        how to close the modal, allowing you to add custom logic before closing.
      </p>
      <Modal>
        <Button variant='secondary'>Open Modal</Button>
        <Modal.Backdrop>
            ...
            <Modal.Dialog className='sm:max-w-[360px]'>
              {(renderProps) => (
                <>
                  ...
                  <Modal.Body>
                    <p>
                      The buttons below use the <code>close</code> method from render props. You can add validation or
                      other logic before calling <code>renderProps.close()</code>.
                    </p>
                  </Modal.Body>
                  <Modal.Footer>
      ...
      <Modal>
        ...
        <Modal.Backdrop>
          <Modal.Container scroll={scroll}>
            <Modal.Dialog className='sm:max-w-[360px]'>
              <Modal.Header>
                <Modal.Heading>Scroll: {scroll.charAt(0).toUpperCase() + scroll.slice(1)}</Modal.Heading>
                <p className='text-sm leading-5 text-muted'>
                  Compare scroll behaviors - inside keeps content scrollable within the modal, outside allows page
                  scrolling
                </p>
              </Modal.Header>
              <Modal.Body>
                {Array.from({ length: 30 }).map((_, i) => (
                  <p key={i} className='mb-3'>
                    Paragraph {i + 1}: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pulvinar risus
                    non risus hendrerit venenatis. Pellentesque sit amet hendrerit risus, sed porttitor quam.
                  </p>
                ))}
              </Modal.Body>
              <Modal.Footer>
    ...
    <div className='flex max-w-md flex-col gap-8'>
      <div className='flex flex-col gap-3'>
        ...
        <p className='text-sm leading-relaxed text-pretty text-muted'>
          Control the modal using React's <code className='text-foreground'>useState</code> hook for simple state
        ...
        <Modal.Backdrop isOpen={isOpen} onOpenChange={setIsOpen}>
          <Modal.Container>
            <Modal.Dialog className='sm:max-w-[360px]'>
              ...
              <Modal.Body>
                <p>
                  This modal is controlled by React's <code>useState</code> hook. Pass <code>isOpen</code> and{' '}
                  <code>onOpenChange</code> props to manage the modal state externally.
                </p>
              </Modal.Body>
              <Modal.Footer>
                <Button slot='close' variant='secondary'>
      ...
      <div className='flex flex-col gap-3'>
        ...
        <p className='text-sm leading-relaxed text-pretty text-muted'>
          Use the <code className='text-foreground'>useOverlayState</code> hook for a cleaner API with convenient
          methods like <code>open()</code>, <code>close()</code>, and <code>toggle()</code>.
        </p>
        <div className='flex flex-col items-start gap-3 rounded-2xl bg-surface p-4 shadow-sm'>
          <div className='flex w-full items-center justify-between'>
            <p className='text-xs text-muted'>
        ...
        <Modal.Backdrop isOpen={state.isOpen} onOpenChange={state.setOpen}>
          <Modal.Container>
            <Modal.Dialog className='sm:max-w-[360px]'>
              ...
              <Modal.Body>
                <p>
                  The <code>useOverlayState</code> hook provides dedicated methods for common operations. No need to
                  manually create callbacks—just use <code>state.open()</code>, <code>state.close()</code>, or{' '}
        ...
        <Modal.Dialog className='sm:max-w-md'>
          ...
          <Modal.Header>
            ...
            <p className='mt-1.5 text-sm leading-5 text-muted'>
              Fill out the form below and we'll get back to you. The modal adapts automatically when the keyboard
              appears on mobile.
            </p>
          </Modal.Header>
          <Modal.Body>
    ...
    <Modal.Backdrop>
      <Modal.Container>
        <Modal.Dialog className='sm:max-w-[360px]'>
          ...
          <Modal.Body>
            <p>
              Use <code>Modal.Trigger</code> to create custom trigger elements beyond standard buttons. This example
              shows a card-style trigger with icons and descriptive text.
            </p>
          </Modal.Body>
          <Modal.Footer>
            <Button slot='close' variant='secondary'>
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div>
        ...
        <p className='text-sm text-muted'>
          Apply <code className='rounded px-1 py-0.5 text-xs'>transform: translateZ(0)</code> to the container to create
