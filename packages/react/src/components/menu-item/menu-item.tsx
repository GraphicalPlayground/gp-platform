...
const MenuItemIndicator = ({ children, className, type = 'checkmark', ...props }: MenuItemIndicatorProps) => {
...
const MenuItemSubmenuIndicator = ({ children, className, ...props }: MenuItemSubmenuIndicatorProps) => {
  const { slots, state } = useContext(MenuItemContext);
