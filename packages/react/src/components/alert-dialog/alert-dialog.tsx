...
import type { AlertDialogVariants } from '@gp/styles';
...
import { alertDialogVariants } from '@gp/styles';
...
const AlertDialogHeader = ({ children, className, ...props }: AlertDialogHeaderProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.header, className)} data-slot='alert-dialog-header' {...props}>
      {children}
    </div>
  );
};
...
const AlertDialogBody = ({ children, className, ...props }: AlertDialogBodyProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.body, className)} data-slot='alert-dialog-body' {...props}>
      {children}
    </div>
  );
};
...
const AlertDialogFooter = ({ children, className, ...props }: AlertDialogFooterProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.footer, className)} data-slot='alert-dialog-footer' {...props}>
      {children}
    </div>
  );
};
 ...
 * AlertDialog Icon
 * -----------------------------------------------------------------------------------------------*/
interface AlertDialogIconProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
