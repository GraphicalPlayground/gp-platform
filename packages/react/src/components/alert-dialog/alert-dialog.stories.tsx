      ...
      <AlertDialog.Backdrop>
        <AlertDialog.Container>
          <AlertDialog.Dialog className='sm:max-w-[400px]'>
            ...
            <AlertDialog.Body>
              <p>
                This will permanently delete <strong>My Awesome Project</strong> and all of its data. This action cannot
                be undone.
              </p>
            </AlertDialog.Body>
            <AlertDialog.Footer>
              ...
              <AlertDialog.Dialog>
                ...
                <AlertDialog.Body>
                  <p>
                    {size === 'cover' ? (
                      <>
                        This alert dialog uses the <code>cover</code> size variant. It spans the full screen with
                        margins: 16px on mobile and 40px on desktop. Maintains rounded corners and standard padding.
                        Perfect for critical confirmations that need maximum width while preserving alert dialog
                        aesthetics.
                      </>
                    ) : (
                      <>
                        This alert dialog uses the <code>{size}</code> size variant. On mobile devices, all sizes adapt
                        to near full-width for optimal viewing. On desktop, each size provides a different maximum width
    ...
    <AlertDialog.Backdrop>
      <AlertDialog.Container>
        <AlertDialog.Dialog className='sm:max-w-[400px]'>
          ...
          <AlertDialog.Body>
            <p>
              We'll send a password reset link to your email address. You'll need to create a new password to regain
    ...
    >
      <AlertDialog.Container>
        <AlertDialog.Dialog className='sm:max-w-[420px]'>
          ...
          <AlertDialog.Body>
            <p>
              This action cannot be undone. All your data, settings, and content will be permanently removed from our
              servers. The dramatic red backdrop emphasizes the severity and irreversibility of this decision.
            </p>
          </AlertDialog.Body>
  ...
  <div className='flex max-w-sm flex-col gap-6'>
    <div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-muted'>
        Controls whether the alert dialog can be dismissed by clicking the overlay backdrop. Alert dialogs typically
        require explicit action, so this defaults to <code>false</code>. Set to <code>true</code> for less critical
        confirmations.
      </p>
      <AlertDialog>
          ...
          <AlertDialog.Container>
            <AlertDialog.Dialog className='sm:max-w-[400px]'>
              ...
              <AlertDialog.Header>
                ...
                <p className='text-sm leading-5 text-muted'>Clicking the backdrop won't close this alert dialog</p>
              </AlertDialog.Header>
              <AlertDialog.Body>
                <p>
                  Try clicking outside this alert dialog on the overlay - it won't close. You must use the action
    ...
    <div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-muted'>
        Controls whether the ESC key can dismiss the alert dialog. Alert dialogs typically require explicit action, so
        this defaults to <code>true</code>. When set to <code>false</code>, the ESC key will be enabled.
      </p>
      <AlertDialog>
        <Button variant='secondary'>Open Alert Dialog</Button>
        <AlertDialog.Backdrop isKeyboardDismissDisabled>
          <AlertDialog.Container>
            <AlertDialog.Dialog className='sm:max-w-[400px]'>
              ...
              <AlertDialog.Body>
                <p>Press ESC - nothing happens. You must use the action buttons to dismiss this alert dialog.</p>
              </AlertDialog.Body>
              <AlertDialog.Footer>
                <Button slot='close' variant='tertiary'>
                  Cancel
...
export const CloseMethods = () => (
  <div className='flex max-w-2xl flex-col gap-8'>
    <div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-muted'>
        The simplest way to close a dialog. Add <code>slot="close"</code> to any Button component within the dialog.
        ...
        <AlertDialog.Backdrop>
          <AlertDialog.Container>
            <AlertDialog.Dialog className='sm:max-w-[400px]'>
              ...
              <AlertDialog.Body>
                <p>
                  Click either button below - both have <code>slot="close"</code> and will close the dialog
                  automatically.
                </p>
              </AlertDialog.Body>
              <AlertDialog.Footer>
    ...
    <div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-muted'>
        ...
        how to close the dialog, allowing you to add custom logic before closing.
      </p>
      <AlertDialog>
        <Button variant='secondary'>Open Dialog</Button>
        <AlertDialog.Backdrop>
    ...
    <div className='flex max-w-md flex-col gap-8'>
      <div className='flex flex-col gap-3'>
        ...
        <p className='text-sm leading-relaxed text-pretty text-muted'>
          Control the alert dialog using React's <code className='text-foreground'>useState</code> hook for simple state
        ...
        <AlertDialog.Backdrop isOpen={isOpen} onOpenChange={setIsOpen}>
          <AlertDialog.Container>
            <AlertDialog.Dialog className='sm:max-w-[400px]'>
              ...
              <AlertDialog.Body>
                <p>
                  This alert dialog is controlled by React's <code>useState</code> hook. Pass <code>isOpen</code> and{' '}
                  <code>onOpenChange</code> props to manage the dialog state externally.
                </p>
              </AlertDialog.Body>
              <AlertDialog.Footer>
                <Button slot='close' variant='tertiary'>
    ...
    <AlertDialog.Backdrop>
      <AlertDialog.Container>
        <AlertDialog.Dialog className='sm:max-w-[400px]'>
          ...
          <AlertDialog.Body>
            <p>
              Use <code>AlertDialog.Trigger</code> to create custom trigger elements beyond standard buttons. This
              example shows a card-style trigger with icons and descriptive text.
            </p>
          </AlertDialog.Body>
          <AlertDialog.Footer>
            <Button slot='close' variant='tertiary'>
