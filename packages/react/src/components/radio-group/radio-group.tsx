...
import type { RadioGroupVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { radioGroupVariants } from '@gp/styles';
...
const RadioGroupRoot = ({ children, className, variant, ...props }: RadioGroupRootProps) => {
  ...
  return (
    <RadioGroupPrimitive data-slot='radio-group' {...props} className={composeTwRenderProps(className, styles)}>
