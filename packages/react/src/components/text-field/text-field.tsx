...
import type { TextFieldVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { textFieldVariants } from '@gp/styles';
...
const TextFieldRoot = ({ children, className, fullWidth, variant, ...props }: TextFieldRootProps) => {
  ...
  return (
    <TextFieldPrimitive data-slot='text-field' {...props} className={composeTwRenderProps(className, styles)}>
      {(values) => (
