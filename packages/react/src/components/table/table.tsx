...
import type { TableVariants } from '@gp/styles';
import type { ComponentPropsWithRef, ReactNode } from 'react';

import { tableVariants } from '@gp/styles';
...
TableRoot.displayName = 'GPlayd.Table';

/* -------------------------------------------------------------------------------------------------
 * Table Scroll Container
 * -----------------------------------------------------------------------------------------------*/
interface TableScrollContainerProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const TableScrollContainer = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  className,
  ...props
}: TableScrollContainerProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof TableScrollContainerProps<E>>) => {
...
TableScrollContainer.displayName = 'GPlayd.Table.ScrollContainer';
...
(TableContent as React.FC).displayName = 'GPlayd.Table.Content';
...
(TableHeader as React.FC).displayName = 'GPlayd.Table.Header';
...
const TableColumn = React.forwardRef<HTMLTableCellElement, TableColumnProps>(({ className, ...props }, ref) => {
  const { slots } = useContext(TableContext);
...
TableColumn.displayName = 'GPlayd.Table.Column';
...
function TableBody<T extends object>({ className, ...props }: TableBodyProps<T>) {
  ...
  return (
    <TableBodyPrimitive className={composeTwRenderProps(className, slots?.body())} data-slot='table-body' {...props} />
  );
}

(TableBody as React.FC).displayName = 'GPlayd.Table.Body';
...
function TableRow<T extends object>({ className, ...props }: TableRowProps<T>) {
  ...
  return <RowPrimitive className={composeTwRenderProps(className, slots?.row())} data-slot='table-row' {...props} />;
}

(TableRow as React.FC).displayName = 'GPlayd.Table.Row';
...
TableCell.displayName = 'GPlayd.Table.Cell';
...
const TableFooter = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.footer, className)} data-slot='table-footer' {...(props as any)} />
  );
};

TableFooter.displayName = 'GPlayd.Table.Footer';
...
TableResizableContainer.displayName = 'GPlayd.Table.ResizableContainer';
...
const TableColumnResizer = React.forwardRef<HTMLDivElement, TableColumnResizerProps>(({ className, ...props }, ref) => {
  const { slots } = useContext(TableContext);
...
TableColumnResizer.displayName = 'GPlayd.Table.ColumnResizer';
...
TableLoadMoreItem.displayName = 'GPlayd.Table.LoadMore';

/* -------------------------------------------------------------------------------------------------
 * Table Load More Content
 * -----------------------------------------------------------------------------------------------*/
interface TableLoadMoreContentProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const TableLoadMoreContent = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  className,
  ...props
}: TableLoadMoreContentProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof TableLoadMoreContentProps<E>>) => {
  const { slots } = useContext(TableContext);
...
TableLoadMoreContent.displayName = 'GPlayd.Table.LoadMoreContent';
