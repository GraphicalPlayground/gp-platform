...
import type { SeparatorVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { separatorVariants } from '@gp/styles';
...
const SeparatorRoot = ({ className, orientation = 'horizontal', variant, ...props }: SeparatorRootProps) => {
  return (
    <SeparatorPrimitive
