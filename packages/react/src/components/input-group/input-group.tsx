...
import type { InputGroupVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { inputGroupVariants } from '@gp/styles';
...
const InputGroupRoot = ({ children, className, fullWidth, onClick, variant, ...props }: InputGroupRootProps) => {
...
const InputGroupPrefix = ({ children, className, ...props }: InputGroupPrefixProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.prefix, className)} data-slot='input-group-prefix' {...props}>
      {children}
    </div>
  );
};
...
const InputGroupSuffix = ({ children, className, ...props }: InputGroupSuffixProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.suffix, className)} data-slot='input-group-suffix' {...props}>
      {children}
    </div>
  );
};
