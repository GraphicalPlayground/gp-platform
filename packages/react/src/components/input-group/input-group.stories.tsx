...
export const WithTextSuffix: Story = {
  render: () => (
    <TextField className='w-[280px]' defaultValue='gplayd' name='website'>
      <Label>Website</Label>
      <InputGroup>
        <InputGroup.Input className='w-[280px]' />
  ...
  render: () => (
    <div className='flex flex-col gap-6'>
      <div className='flex flex-col gap-4'>
        ...
        <TextField className='w-[280px]' defaultValue='gplayd' name='website2'>
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Input className='w-[280px]' />
            <InputGroup.Suffix>.com</InputGroup.Suffix>
        ...
        <TextField className='w-[280px]' defaultValue='gplayd' name='website3'>
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Prefix>
              <Icon className='size-4 text-muted' icon='gravity-ui:globe' />
