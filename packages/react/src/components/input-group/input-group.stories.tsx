...
export const WithTextPrefix: Story = {
  render: () => (
    <TextField className='w-[280px]' defaultValue='graphical-playground.com' name='website'>
      <Label>Website</Label>
      <InputGroup>
...
export const WithTextSuffix: Story = {
  render: () => (
    <TextField className='w-[280px]' defaultValue='graphical-playground' name='website'>
      <Label>Website</Label>
      <InputGroup>
        <InputGroup.Input className='w-[280px]' />
...
export const WithTextArea: Story = {
  render: () => {
    ...
    return (
      <TextField fullWidth aria-label='Prompt input' className='flex w-sm flex-col sm:w-lg' name='prompt'>
          ...
          <InputGroup.Suffix className='flex w-full items-center gap-1.5 px-3 py-0'>
            ...
            <div className='ml-auto flex items-center gap-1.5'>
              ...
              <Tooltip delay={0}>
                ...
                >
                  {({ isPending }) =>
                    isPending ? <Spinner color='current' size='sm' /> : <Icon icon='gravity-ui:arrow-up' />
                  }
                </Button>
  ...
  render: () => (
    <div className='flex flex-col gap-6'>
      <div className='flex flex-col gap-4'>
        ...
        <TextField className='w-[280px]' defaultValue='graphical-playground.com' name='website1'>
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Prefix>https://</InputGroup.Prefix>
            <InputGroup.Input className='w-[280px]' />
        ...
        <TextField className='w-[280px]' defaultValue='graphical-playground' name='website2'>
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Input className='w-[280px]' />
            <InputGroup.Suffix>.com</InputGroup.Suffix>
        ...
        <TextField className='w-[280px]' defaultValue='graphical-playground' name='website3'>
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Prefix>
              <Icon className='size-4 text-muted' icon='gravity-ui:globe' />
        ...
        <TextField className='w-[280px]' defaultValue='graphical-playground.com' name='website4'>
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Input className='w-[280px]' />
            <InputGroup.Suffix className='pr-0'>
        ...
        <TextField className='w-[280px]' defaultValue='graphical-playground.com' name='website5'>
          <Label>Website</Label>
          <InputGroup>
            <InputGroup.Prefix>
              <Icon className='size-4 text-muted' icon='gravity-ui:globe' />
