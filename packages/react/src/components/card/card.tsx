...
const CardHeader = ({ className, ...props }: CardHeaderProps) => {
  ...
  return <div className={composeSlotClassName(slots?.header, className)} data-slot='card-header' {...props} />;
};
...
const CardDescription = ({ children, className, ...props }: CardDescriptionProps) => {
  ...
  return (
    <p className={composeSlotClassName(slots?.description, className)} data-slot='card-description' {...props}>
      {children}
    </p>
  );
};
...
const CardContent = ({ className, ...props }: CardContentProps) => {
  ...
  return <div className={composeSlotClassName(slots?.content, className)} data-slot='card-content' {...props} />;
};
...
const CardFooter = ({ className, ...props }: CardFooterProps) => {
  ...
  return <div className={composeSlotClassName(slots?.footer, className)} data-slot='card-footer' {...props} />;
};
