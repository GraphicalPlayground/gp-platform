...
import type { CardVariants } from '@gp/styles';
import type { ReactNode } from 'react';

import { cardVariants } from '@gp/styles';
...
const CardHeader = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.header, className)} data-slot='card-header' {...(props as any)} />
  );
};
...
const CardTitle = <E extends keyof React.JSX.IntrinsicElements = 'h3'>({
  ...
  return (
    <dom.h3 className={composeSlotClassName(slots?.title, className)} data-slot='card-title' {...(props as any)}>
      {children}
    </dom.h3>
  );
};
...
const CardContent = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.content, className)} data-slot='card-content' {...(props as any)} />
  );
};
...
const CardFooter = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.footer, className)} data-slot='card-footer' {...(props as any)} />
  );
};
