...
export const Default: Story = {
  render: (args) => (
    <Card className='w-[400px]' {...args}>
      <Icon aria-label='Dollar sign icon' className='text-primary size-6' icon='gravity-ui:circle-dollar' role='img' />
      <Card.Header>
      ...
      <Card.Footer>
        <Link
          ...
          href='https://graphical-playground.com'
    ...
    <Card className='w-full items-stretch md:flex-row' {...args}>
      ...
      <div className='flex flex-1 flex-col gap-3'>
        <Card.Header className='gap-1'>
          ...
          <Card.Description>
            Experience unmatched luxury and performance with the Porsche 911 Golden Edition—where sleek design meets
            cutting-edge tech and pure driving thrill.
          </Card.Description>
        </Card.Header>
        <Card.Footer className='mt-auto flex w-full flex-row items-center justify-between'>
          <div className='flex flex-col'>
            <span aria-label='Price: 36,799 US dollars' className='text-sm font-medium text-foreground'>
              $36,799
            </span>
      ...
      <div className='grid w-full max-w-2xl grid-cols-12 gap-4 p-4'>
        ...
        <div className='col-span-12 grid grid-cols-12 gap-4'>
          ...
          <Card className='col-span-12 min-h-[200px] rounded-3xl lg:col-span-6' {...args}>
            ...
            <div aria-hidden='true' className='pointer-events-none absolute right-0 bottom-0 left-0 h-[64px]'>
              <div
        ...
        <div className='col-span-12 grid grid-cols-12 gap-4'>
          {/* Left Column: Card */}
          <Card className='relative col-span-12 h-[250px] sm:h-[300px] md:col-span-8 md:h-[350px]' {...args}>
            <img
              alt='NEO Home Robot'
              aria-hidden='true'
              className='absolute inset-0 h-full w-full object-cover'
            ...
            {/* Bottom gradient blur overlay */}
            <div aria-hidden='true' className='pointer-events-none absolute right-0 bottom-0 left-0 h-16 sm:h-20'>
              <div
                className='absolute inset-0 h-[100%] rounded-b-[inherit] backdrop-blur-sm'
                style={{
                  WebkitMaskImage: 'linear-gradient(to top, black 30%, transparent)',
