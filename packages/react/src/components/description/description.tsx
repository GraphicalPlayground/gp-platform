...
import type { DescriptionVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';
import type { TextProps } from 'react-aria-components';

import { descriptionVariants } from '@gp/styles';
...
const DescriptionRoot = ({ children, className, ...rest }: DescriptionRootProps) => {
  return (
    <Text className={descriptionVariants({ className })} data-slot='description' slot='description' {...rest}>
      {children}
    </Text>
  );
};
