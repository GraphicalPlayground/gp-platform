...
RangeCalendarRoot.displayName = 'GP.RangeCalendar';
...
const RangeCalendarHeader = ({ children, className, ...props }: RangeCalendarHeaderProps) => {
  ...
  return (
    <header className={composeSlotClassName(slots?.header, className)} data-slot='range-calendar-header' {...props}>
      {children}
    </header>
  );
};

RangeCalendarHeader.displayName = 'GP.RangeCalendar.Header';
...
RangeCalendarHeading.displayName = 'GP.RangeCalendar.Heading';
...
RangeCalendarNavButton.displayName = 'GP.RangeCalendar.NavButton';
...
RangeCalendarGrid.displayName = 'GP.RangeCalendar.Grid';
...
RangeCalendarGridHeader.displayName = 'GP.RangeCalendar.GridHeader';
...
RangeCalendarGridBody.displayName = 'GP.RangeCalendar.GridBody';
...
RangeCalendarHeaderCell.displayName = 'GP.RangeCalendar.HeaderCell';
...
RangeCalendarCell.displayName = 'GP.RangeCalendar.Cell';
...
RangeCalendarCellIndicator.displayName = 'GP.RangeCalendar.CellIndicator';
