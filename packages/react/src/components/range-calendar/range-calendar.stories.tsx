 ...
 * -----------------------------------------------------------------------------------------------*/
const RangeCalendarTemplate = (props: Omit<React.ComponentProps<typeof RangeCalendar>, 'children'>) => (
  <RangeCalendar {...props}>
 ...
 * -----------------------------------------------------------------------------------------------*/
const RangeCalendarTemplateWithYearPicker = (props: Omit<React.ComponentProps<typeof RangeCalendar>, 'children'>) => (
  <RangeCalendar {...props}>
    <RangeCalendar.Header>
  ...
  render: (args) => {
    ...
    return (
      <div className='flex flex-col items-center gap-4'>
        ...
        <Description className='text-center'>Select dates between today and {maxDate.toString()}</Description>
      </div>
    );
  }
};
    ...
    return (
      <div className='flex flex-col items-center gap-4'>
        <RangeCalendarTemplate
          ...
          isDateUnavailable={isDateUnavailable}
        />
        <Description className='text-center'>Non-contiguous ranges are allowed across unavailable dates</Description>
      </div>
    );
  }
};
              ...
              {(date) => (
                <RangeCalendar.Cell date={date}>
                  {({ formattedDate, isUnavailable }) => (
                    <>
                      {formattedDate}
                      {!isUnavailable && !isWeekend(date, locale) && blockedDates.includes(date.day) && (
                        <RangeCalendar.CellIndicator />
                      )}
                    </>
                  )}
