...
import type { ToolbarVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { toolbarVariants } from '@gp/styles';
...
const ToolbarRoot = ({ children, className, isAttached, orientation = 'horizontal', ...props }: ToolbarRootProps) => {
  const styles = React.useMemo(() => toolbarVariants({ isAttached, orientation }), [isAttached, orientation]);
...
ToolbarRoot.displayName = 'GPlayd.Toolbar';
