...
export const Disabled: Story = {
  render: () => (
    <div className='flex flex-col gap-4'>
      <ColorField isDisabled className='w-[280px]' defaultValue={parseColor('#0485F7')} name='color'>
        <Label>Color</Label>
        <ColorField.Group>
          <ColorField.Input />
        </ColorField.Group>
  ...
  render: () => {
    ...
    return (
      <div className='flex flex-col gap-4'>
        ...
        <div className='flex gap-4'>
          <ColorField channel='red' className='w-[80px]' colorSpace='rgb' name='red' value={color} onChange={setColor}>
            <Label>Red</Label>
            <ColorField.Group>
              <ColorField.Input />
            </ColorField.Group>
  ...
  render: () => {
    ...
    return (
      <Form className='flex w-[280px] flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <Button className='w-full' isDisabled={!value} isPending={isSubmitting} type='submit' variant='primary'>
  ...
  render: () => {
    ...
    return (
      <div className='flex flex-col gap-6'>
        <div className='flex flex-col gap-4'>
          <ColorField isRequired className='w-[280px]' name='color1' value={color1} onChange={setColor1}>
          ...
          <ColorField isRequired className='w-[280px]' name='color2' value={color2} onChange={setColor2}>
          ...
          <ColorField isRequired className='w-[280px]' name='color3' value={color3} onChange={setColor3}>
            <Label>Secondary Variant</Label>
            <ColorField.Group variant='secondary'>
              <ColorField.Prefix>
