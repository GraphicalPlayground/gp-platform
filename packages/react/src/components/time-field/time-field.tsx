...
import type { TimeFieldVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';
import type { TimeValue } from 'react-aria-components';

import { timeFieldVariants } from '@gp/styles';
...
function TimeFieldRoot<T extends TimeValue>({ children, className, fullWidth, ...props }: TimeFieldRootProps<T>) {
