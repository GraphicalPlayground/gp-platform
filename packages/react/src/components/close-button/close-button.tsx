...
import type { CloseButtonVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { closeButtonVariants } from '@gp/styles';
...
const CloseButtonRoot = ({ children, className, slot, style, variant, ...rest }: CloseButtonRootProps) => {
