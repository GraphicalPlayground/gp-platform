...
import type { DrawerVariants } from '@gp/styles';
...
import { drawerVariants } from '@gp/styles';
...
function useDrawerDrag(placement: DrawerPlacement | undefined, isDismissable: boolean) {
  ...
  const getPos = useCallback((e: React.PointerEvent) => (isVertical ? e.clientY : e.clientX), [isVertical]);
...
DrawerRoot.displayName = 'GPlayd.Drawer';
...
DrawerTrigger.displayName = 'GPlayd.Drawer.Trigger';
...
const DrawerBackdrop = ({ children, className, isDismissable = true, variant, ...props }: DrawerBackdropProps) => {
...
DrawerBackdrop.displayName = 'GPlayd.Drawer.Backdrop';
...
const DrawerContent = ({ children, className, placement = 'bottom', ...props }: DrawerContentProps) => {
...
DrawerContent.displayName = 'GPlayd.Drawer.Content';
...
DrawerDialog.displayName = 'GPlayd.Drawer.Dialog';
...
const DrawerHeader = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.header, className)} data-slot='drawer-header' {...(props as any)}>
      {children}
    </dom.div>
  );
};

DrawerHeader.displayName = 'GPlayd.Drawer.Header';
...
DrawerBody.displayName = 'GPlayd.Drawer.Body';
...
const DrawerFooter = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.footer, className)} data-slot='drawer-footer' {...(props as any)}>
      {children}
    </dom.div>
  );
};

DrawerFooter.displayName = 'GPlayd.Drawer.Footer';
...
DrawerHeading.displayName = 'GPlayd.Drawer.Heading';
...
DrawerHandle.displayName = 'GPlayd.Drawer.Handle';
...
DrawerCloseTrigger.displayName = 'GPlayd.Drawer.CloseTrigger';
