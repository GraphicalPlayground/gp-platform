      ...
      <Drawer.Backdrop>
        <Drawer.Content>
          <Drawer.Dialog>
            ...
            <Drawer.Body>
              <p>
                This is a bottom drawer built with React Aria's Modal component. It slides up from the bottom of the
          ...
          <Drawer.Backdrop>
            <Drawer.Content placement={placement}>
              <Drawer.Dialog>
                ...
                <Drawer.Header>
                  <Drawer.Heading>{placement.charAt(0).toUpperCase() + placement.slice(1)} Drawer</Drawer.Heading>
                </Drawer.Header>
                <Drawer.Body>
                  <p>
          ...
          <Drawer.Backdrop variant={variant}>
            <Drawer.Content>
              <Drawer.Dialog>
                ...
                <Drawer.CloseTrigger />
                <Drawer.Header>
                  <Drawer.Heading>Backdrop: {variant.charAt(0).toUpperCase() + variant.slice(1)}</Drawer.Heading>
                </Drawer.Header>
                <Drawer.Body>
                  <p>
          ...
          <Drawer.Body>
            {Array.from({ length: 20 }).map((_, i) => (
              <p key={i} className='mb-3'>
                Paragraph {i + 1}: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pulvinar risus non
    ...
    <Drawer.Backdrop isDismissable={false}>
      <Drawer.Content>
        <Drawer.Dialog>
          ...
          <Drawer.Body>
            <p>This drawer cannot be dismissed by clicking outside. You must use one of the buttons below.</p>
          </Drawer.Body>
          <Drawer.Footer>
            <Button slot='close' variant='secondary'>
              Cancel
