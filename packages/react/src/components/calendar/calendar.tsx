...
CalendarRoot.displayName = 'GP.Calendar';
...
const CalendarHeader = ({ children, className, ...props }: CalendarHeaderProps) => {
  ...
  return (
    <header className={composeSlotClassName(slots?.header, className)} data-slot='calendar-header' {...props}>
      {children}
    </header>
  );
};

CalendarHeader.displayName = 'GP.Calendar.Header';
...
CalendarHeading.displayName = 'GP.Calendar.Heading';
...
CalendarNavButton.displayName = 'GP.Calendar.NavButton';
...
CalendarGrid.displayName = 'GP.Calendar.Grid';
...
CalendarGridHeader.displayName = 'GP.Calendar.GridHeader';
...
CalendarGridBody.displayName = 'GP.Calendar.GridBody';
...
CalendarHeaderCell.displayName = 'GP.Calendar.HeaderCell';
...
CalendarCell.displayName = 'GP.Calendar.Cell';
...
CalendarCellIndicator.displayName = 'GP.Calendar.CellIndicator';
