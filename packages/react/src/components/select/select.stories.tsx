  ...
  render: () => {
    ...
    return (
      <div className='space-y-2'>
        <Select className='w-[256px]' placeholder='Select a state' value={state} onChange={(value) => setState(value)}>
  ...
  render: () => {
    ...
    return (
      <div className='space-y-4'>
        ...
        <p className='text-sm text-muted'>Selected: {selected.length > 0 ? selected.join(', ') : 'None'}</p>
      </div>
    );
  }
};
...
export const ControlledOpenState: Story = {
  render: () => {
    ...
    return (
      <div className='space-y-4'>
        <Select className='w-[256px]' isOpen={isOpen} placeholder='Select one' onOpenChange={setIsOpen}>
          <Label>State</Label>
          <Select.Trigger>
            <Select.Value />
            <Select.Indicator />
