...
import type { DateRangePickerVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';
import type { DateValue } from 'react-aria-components';

import { dateRangePickerVariants } from '@gp/styles';
...
DateRangePickerRoot.displayName = 'GP.DateRangePicker';
...
DateRangePickerTrigger.displayName = 'GP.DateRangePicker.Trigger';
...
const DateRangePickerTriggerIndicator = ({ children, className, ...props }: DateRangePickerTriggerIndicatorProps) => {
...
DateRangePickerTriggerIndicator.displayName = 'GP.DateRangePicker.TriggerIndicator';
...
DateRangePickerRangeSeparator.displayName = 'GP.DateRangePicker.RangeSeparator';
...
const DateRangePickerPopover = ({
  ...
  return (
    ...
    >
      <PopoverPrimitive {...props} className={composeTwRenderProps(className, slots?.popover())} placement={placement}>
        {children}
      </PopoverPrimitive>
    </SurfaceContext>
  );
...
DateRangePickerPopover.displayName = 'GP.DateRangePicker.Popover';
