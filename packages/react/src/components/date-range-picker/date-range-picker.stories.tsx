...
export const WithValidation: Story = {
  render: () => {
    ...
    const isInvalid = value != null && (value.start.compare(currentDate) < 0 || value.end.compare(value.start) < 0);
...
export const WithCustomIndicator: Story = {
  render: () => (
    <DateRangePicker className='w-[320px]' endName='endDate' startName='startDate'>
      ...
      <Description>Use a custom trigger icon while preserving DateRangePicker behavior.</Description>
      <DateRangePicker.Popover>
        <RangeCalendarContent />
      </DateRangePicker.Popover>
    </DateRangePicker>
  ...
  render: () => {
    ...
    return (
      <Form className='flex w-[320px] flex-col gap-3' onSubmit={handleSubmit}>
        ...
        <Button className='w-full' isDisabled={!value || isInvalid} isPending={isSubmitting} type='submit'>
