...
import type { ListBoxVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { listboxVariants } from '@gp/styles';
...
function ListBoxRoot<T extends object>({ className, variant, ...props }: ListBoxRootProps<T>) {
  ...
  return <ListBoxPrimitive className={composeTwRenderProps(className, styles)} data-slot='list-box' {...props} />;
}
