    ...
    <ListBox aria-label='Users' className='w-[220px]' selectionMode='single'>
      <ListBox.Item id='1' textValue='Bob'>
        ...
        <div className='flex flex-col'>
          <Label>Bob</Label>
          <Description>bob@graphical-playground.com</Description>
        </div>
      ...
      <ListBox.Item id='2' textValue='Fred'>
        ...
        <div className='flex flex-col'>
          <Label>Fred</Label>
          <Description>fred@graphical-playground.com</Description>
        </div>
        <ListBox.ItemIndicator />
      </ListBox.Item>
      <ListBox.Item id='3' textValue='Martha'>
        ...
        <div className='flex flex-col'>
          <Label>Martha</Label>
          <Description>martha@graphical-playground.com</Description>
        </div>
        <ListBox.ItemIndicator />
      </ListBox.Item>
    </ListBox>
    ...
    <Surface className='w-[256px] rounded-3xl shadow-surface'>
      <ListBox aria-label='Users' selectionMode='multiple'>
        <ListBox.Item id='1' textValue='Bob'>
          ...
          <ListBox.ItemIndicator>
            {({ isSelected }) => (isSelected ? <Icon className='size-4 text-accent' icon='gravity-ui:check' /> : null)}
          </ListBox.ItemIndicator>
        </ListBox.Item>
        <ListBox.Item id='2' textValue='Fred'>
          <Avatar size='sm'>
  ...
  render: () => {
    ...
    return (
      <div className='space-y-4'>
        <Surface className='w-[256px] rounded-3xl shadow-surface'>
          <ListBox aria-label='Users' selectedKeys={selected} selectionMode='multiple' onSelectionChange={setSelected}>
            <ListBox.Item id='1' textValue='Bob'>
              <Avatar size='sm'>
                <AvatarImage src='https://heroui-assets.nyc3.cdn.digitaloceanspaces.com/avatars/blue.jpg' />
                <AvatarFallback>B</AvatarFallback>
