...
import type { MenuVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { menuVariants } from '@gp/styles';
...
function MenuRoot<T extends object>({ className, ...props }: MenuRootProps<T>) {
  ...
  return <MenuPrimitive className={composeTwRenderProps(className, styles)} data-slot='menu' {...props} />;
}
