          ...
          {typeof children === 'function' ? (
            ...
            <>
              ...
              {!!renderProps.allowsRemoving &&
                (removeButtonChildren && removeButtonChildren.length > 0 ? removeButtonChildren : <TagRemoveButton />)}
            </>
          )}
        </TagContext>
      )}
