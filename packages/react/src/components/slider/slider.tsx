...
import type { SliderVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';
import type { SliderRenderProps } from 'react-aria-components/Slider';

import { sliderVariants } from '@gp/styles';
...
const SliderRoot = ({ children, className, orientation = 'horizontal', ...props }: SliderRootProps) => {
...
const SliderMarks = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.marks, className)} data-slot='slider-marks' {...(props as any)} />
  );
};
