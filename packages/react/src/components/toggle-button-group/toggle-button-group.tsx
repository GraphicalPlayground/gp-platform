...
import type { ToggleButtonGroupVariants, ToggleButtonVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { toggleButtonGroupVariants } from '@gp/styles';
 ...
 * -----------------------------------------------------------------------------------------------*/
interface ToggleButtonGroupSeparatorProps<E extends keyof React.JSX.IntrinsicElements = 'span'> extends DOMRenderProps<
  E,
  undefined
> {
  className?: string;
