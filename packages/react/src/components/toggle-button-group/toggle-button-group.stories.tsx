  ...
  render: function ControlledStory() {
    ...
    return (
      <div className='flex flex-col gap-4'>
        <ToggleButtonGroup selectedKeys={selectedKeys} selectionMode='multiple' onSelectionChange={setSelectedKeys}>
          <ToggleButton isIconOnly aria-label='Bold' id='bold'>
            <Icon icon='gravity-ui:bold' />
          </ToggleButton>
          <ToggleButton isIconOnly aria-label='Italic' id='italic'>
        ...
        <p className='text-sm text-muted'>
          Selected: <span className='font-medium'>{selectedKeys.size > 0 ? [...selectedKeys].join(', ') : 'None'}</span>
        </p>
      </div>
    );
  }
      ...
      <div className='flex flex-col items-start gap-8'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className='flex gap-2'>
            <ToggleButtonGroup selectedKeys={formatting} selectionMode='multiple' onSelectionChange={setFormatting}>
              <ToggleButton isIconOnly aria-label='Bold' id='bold'>
                <Icon icon='gravity-ui:bold' />
              </ToggleButton>
              <ToggleButton isIconOnly aria-label='Italic' id='italic'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <ToggleButtonGroup disallowEmptySelection defaultSelectedKeys={['grid']} selectionMode='single' size='sm'>
