...
import type { DropdownVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { dropdownVariants } from '@gp/styles';
...
const DropdownTrigger = ({ children, className, ...props }: DropdownTriggerProps) => {
  ...
  return (
    <Button className={composeTwRenderProps(className, slots?.trigger())} data-slot='dropdown-trigger' {...props}>
