    ...
    return (
      <Dropdown>
        ...
        <Dropdown.Popover className='min-w-[256px]'>
          <Dropdown.Menu selectedKeys={selected} selectionMode='single' onSelectionChange={setSelected}>
            <Dropdown.Section>
  ...
  render: () => {
    ...
    return (
      <Dropdown>
        ...
        <Dropdown.Popover className='min-w-[256px]'>
          <Dropdown.Menu selectedKeys={selected} selectionMode='multiple' onSelectionChange={setSelected}>
            <Dropdown.Section>
              <Header>Select a fruit</Header>
              <Dropdown.Item id='apple' textValue='Apple'>
                <Dropdown.ItemIndicator />
      ...
      <Dropdown>
        ...
        <Dropdown.Popover className='min-w-[256px]'>
          <Dropdown.Menu>
            ...
            <Separator />
            <Dropdown.Section selectedKeys={textStyles} selectionMode='multiple' onSelectionChange={setTextStyles}>
            ...
            <Separator />
            <Dropdown.Section selectedKeys={textAlignment} selectionMode='single' onSelectionChange={setTextAlignment}>
  ...
  render: () => {
    ...
    return (
      <div className='min-w-sm space-y-4'>
        ...
        <p className='text-sm text-muted'>Selected: {selectedItems.length > 0 ? selectedItems.join(', ') : 'None'}</p>
      </div>
    );
  }
};
