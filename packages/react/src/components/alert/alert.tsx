...
import type { AlertVariants } from '@gp/styles';
import type { ReactNode } from 'react';

import { alertVariants } from '@gp/styles';
 ...
 * Alert Indicator
 * --------------------------------------------------------------------------------------------- */
interface AlertIndicatorProps<E extends keyof React.JSX.IntrinsicElements = 'div'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const AlertContent = <E extends keyof React.JSX.IntrinsicElements = 'div'>({
  ...
  return (
    <dom.div className={composeSlotClassName(slots?.content, className)} data-slot='alert-content' {...(rest as any)}>
      {children}
    </dom.div>
  );
};
...
const AlertTitle = <E extends keyof React.JSX.IntrinsicElements = 'p'>({
  ...
  return (
    <dom.p className={composeSlotClassName(slots?.title, className)} data-slot='alert-title' {...(rest as any)}>
      {children}
    </dom.p>
  );
};
 ...
 * Alert Description
 * --------------------------------------------------------------------------------------------- */
interface AlertDescriptionProps<E extends keyof React.JSX.IntrinsicElements = 'span'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
