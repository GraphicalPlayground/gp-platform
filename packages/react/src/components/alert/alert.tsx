...
const AlertIndicator = ({ children, className, ...rest }: AlertIndicatorProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.indicator, className)} data-slot='alert-indicator' {...rest}>
...
const AlertContent = ({ children, className, ...rest }: AlertContentProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.content, className)} data-slot='alert-content' {...rest}>
      {children}
    </div>
  );
};
...
const AlertDescription = ({ children, className, ...rest }: AlertDescriptionProps) => {
  ...
  return (
    <span className={composeSlotClassName(slots?.description, className)} data-slot='alert-description' {...rest}>
      {children}
    </span>
  );
};
