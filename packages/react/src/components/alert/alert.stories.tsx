  ...
  <div className='grid w-full max-w-xl gap-4'>
    ...
    <Alert status='warning'>
      ...
      <Alert.Content>
        ...
        <Alert.Description>
          You're using 90% of your storage quota. Consider upgrading your plan or removing unused files to avoid service
          interruption.
        </Alert.Description>
        <Button className='mt-2 sm:hidden' size='sm' variant='secondary'>
          Manage Storage
    ...
    <Alert status='accent'>
      ...
      <Alert.Content>
        ...
        <Alert.Description>Please wait while we sync your data. This may take a few moments.</Alert.Description>
      </Alert.Content>
    </Alert>
