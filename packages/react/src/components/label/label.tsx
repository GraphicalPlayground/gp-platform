...
import type { LabelVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { labelVariants } from '@gp/styles';
...
const LabelRoot = ({ children, className, isDisabled, isInvalid, isRequired, ...rest }: LabelRootProps) => {
  return (
    <LabelPrimitive
