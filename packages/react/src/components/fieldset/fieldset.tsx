...
import type { FieldsetVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';

import { fieldsetVariants } from '@gp/styles';
...
const FieldsetLegend = ({ className, ...props }: FieldsetLegendProps) => {
  ...
  return <legend className={composeSlotClassName(slots?.legend, className)} data-slot='fieldset-legend' {...props} />;
};
...
const FieldGroup = ({ className, ...rest }: FieldGroupProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.fieldGroup, className)} data-slot='fieldset-field-group' {...rest} />
  );
};
...
const FieldsetActions = ({ children, className, ...rest }: FieldsetActionsProps) => {
  ...
  return (
    <div className={composeSlotClassName(slots?.actions, className)} data-slot='fieldset-actions' {...rest}>
      {children}
    </div>
  );
};
