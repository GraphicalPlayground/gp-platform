...
import type { AccordionVariants } from '@gp/styles';
import type { ComponentPropsWithRef, ReactNode } from 'react';

import { accordionVariants } from '@gp/styles';
...
const AccordionRoot = ({ children, className, hideSeparator = false, variant, ...props }: AccordionRootProps) => {
  const slots = React.useMemo(() => accordionVariants({ variant }), [variant]);

  const content = (
    <DisclosureGroup className={composeTwRenderProps(className, slots.base())} data-slot='accordion' {...props}>
 ...
 * AccordionIndicator
 * -----------------------------------------------------------------------------------------------*/
interface AccordionIndicatorProps<E extends keyof React.JSX.IntrinsicElements = 'svg'> extends DOMRenderProps<
  E,
  undefined
> {
  children?: ReactNode;
...
const AccordionIndicator = <E extends keyof React.JSX.IntrinsicElements = 'svg'>({
  ...
  className,
  ...props
}: AccordionIndicatorProps<E> & Omit<React.JSX.IntrinsicElements[E], keyof AccordionIndicatorProps<E>>) => {
