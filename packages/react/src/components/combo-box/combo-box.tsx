...
import type { ComboBoxVariants } from '@gp/styles';
import type { ComponentPropsWithRef, ReactNode } from 'react';
import type { ButtonProps } from 'react-aria-components';

import { comboBoxVariants } from '@gp/styles';
...
const ComboBoxPopover = ({ children, className, placement = 'bottom', ...props }: ComboBoxPopoverProps) => {
  const { slots } = useContext(ComboBoxContext);
