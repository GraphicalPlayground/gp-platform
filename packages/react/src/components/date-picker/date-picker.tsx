...
import type { DatePickerVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';
import type { DateValue } from 'react-aria-components';

import { datePickerVariants } from '@gp/styles';
...
DatePickerRoot.displayName = 'GP.DatePicker';
...
DatePickerTrigger.displayName = 'GP.DatePicker.Trigger';
...
const DatePickerTriggerIndicator = ({ children, className, ...props }: DatePickerTriggerIndicatorProps) => {
...
DatePickerTriggerIndicator.displayName = 'GP.DatePicker.TriggerIndicator';
...
const DatePickerPopover = ({ children, className, placement = 'bottom', ...props }: DatePickerPopoverProps) => {
  const { slots } = useContext(DatePickerContext);
...
DatePickerPopover.displayName = 'GP.DatePicker.Popover';
