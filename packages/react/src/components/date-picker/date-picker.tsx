...
DatePickerRoot.displayName = 'GPlayd.DatePicker';
...
DatePickerTrigger.displayName = 'GPlayd.DatePicker.Trigger';

/* -------------------------------------------------------------------------------------------------
 * DatePicker Trigger Indicator
 * -----------------------------------------------------------------------------------------------*/
interface DatePickerTriggerIndicatorProps<E extends keyof React.JSX.IntrinsicElements = 'span'> extends DOMRenderProps<
  E,
  undefined
> {
...
DatePickerTriggerIndicator.displayName = 'GPlayd.DatePicker.TriggerIndicator';
...
DatePickerPopover.displayName = 'GPlayd.DatePicker.Popover';
