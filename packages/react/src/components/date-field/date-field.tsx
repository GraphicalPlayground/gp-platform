...
import type { DateFieldVariants } from '@gp/styles';
import type { ComponentPropsWithRef } from 'react';
import type { DateValue } from 'react-aria-components/Calendar';

import { dateFieldVariants } from '@gp/styles';
...
function DateFieldRoot<T extends DateValue>({ children, className, fullWidth, ...props }: DateFieldRootProps<T>) {
