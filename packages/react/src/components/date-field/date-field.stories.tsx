  ...
  render: () => {
    ...
    return (
      <div className='flex gap-4'>
        <DateField className='w-[256px]' defaultValue={defaultValue} granularity={granularity} name='granularity-date'>
          <Label>Appointment Date</Label>
          <DateField.Group>
            <DateField.Input>{(segment) => <DateField.Segment segment={segment} />}</DateField.Input>
          </DateField.Group>
          ...
          <div className='flex items-center gap-2'>
            ...
            <Tooltip delay={0}>
              ...
              <Tooltip.Content placement='bottom start'>
                <p>
                  Determines the smallest unit displayed in the date picker. By default, this is "day" for dates, and
                  "minute" for times.
                </p>
              </Tooltip.Content>
            </Tooltip>
