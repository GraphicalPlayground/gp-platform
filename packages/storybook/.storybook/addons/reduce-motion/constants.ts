export const REDUCE_MOTION_ADDON_ID = 'gp-reduce-motion-addon';
export const REDUCE_MOTION_GLOBAL_TYPE_ID = 'gp-reduce-motion';
export const REDUCE_MOTION_PARAM_KEY = 'gp-reduce-motion';
