  ...
  return (
    <div className='mx-auto max-w-4xl p-6'>
      <div className='mb-8'>
        ...
        <p className='text-muted'>GP-Platform's color palette with CSS variables and computed values</p>
      </div>
      ...
      <div className='mb-8'>
        ...
        <ColorSection colors={calculatedInSurfaceSecondaryColors} title='On Surface Colors - Secondary' />
        <ColorSection colors={calculatedInSurfaceTertiaryColors} title='On Surface Colors - Tertiary' />
...
AllColors.parameters = {
  docs: {
    description: {
      story:
        'A comprehensive overview of all color tokens available in the GP-Platform design system. Each color shows its CSS variable name and computed value.'
    }
  }
};
