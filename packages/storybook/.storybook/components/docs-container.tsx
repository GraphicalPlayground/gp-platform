...
import { DEFAULT_THEME, THEME_EVENT_NAME, THEME_GLOBAL_TYPE_ID, ensureThemeKey } from '../addons/theme/constants';
 ...
 */
export const DocsContainer: NonNullable<Preview['parameters']>['docs']['container'] = ({ children, context }) => {
  ...
  useEffect(() => {
    const next = ensureThemeKey((context?.globals?.[THEME_GLOBAL_TYPE_ID] as string | undefined) || undefined);
