...
import { GPlaydLogo } from '../gplayd-logo';
  ...
  return (
    <div>
      ...
      <main className='flex flex-col gap-4 p-6'>
        ...
        <p className='rounded-xl text-sm text-muted'>GPlayd is the modern UI library for web and mobile.</p>
        {/* Buttons */}
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-wrap items-center gap-2'>
              ...
              <Avatar>
                <Avatar.Image alt='User' src='https://img.heroui.chat/image/avatar?w=400&h=400&u=3' />
              ...
              <AlertDialog.Backdrop>
                <AlertDialog.Container>
                  <AlertDialog.Dialog className='sm:max-w-[400px]'>
                    ...
                    <AlertDialog.Body>
                      <p className='text-sm text-muted'>You have unsaved changes that will be permanently lost.</p>
                    </AlertDialog.Body>
                    <AlertDialog.Footer>
                      <Button slot='close' variant='tertiary'>
                        Keep Editing
                ...
                <Modal.Container>
                  <Modal.Dialog className='sm:max-w-md'>
                    ...
                    <Modal.Header>
                      ...
                      <p className='text-sm text-muted'>Fill out the form below and we'll get back to you.</p>
                    </Modal.Header>
                      ...
                      <Surface variant='default'>
                        <div className='flex flex-col gap-4'>
                          ...
                          <div className='flex flex-col gap-1'>
                            ...
                            <Input fullWidth placeholder='Enter your email' type='email' variant='secondary' />
                          </div>
                        </div>
                      </Surface>
                    </Modal.Body>
                  ...
                  <Modal.Dialog className='sm:max-w-[360px]'>
                    ...
                    <Modal.Body>
                      <p className='text-center text-sm text-muted'>
                        This modal features a sophisticated gradient backdrop with blur effect that adapts to light and
                        dark modes.
                      </p>
                    </Modal.Body>
