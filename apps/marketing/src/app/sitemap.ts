...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return SeoSitemap.for('marketing', Urls.BaseUrl).build([
    ...
    { path: '/products', changeFrequency: 'monthly', priority: 0.4 },
    { path: '/products/engine', changeFrequency: 'monthly', priority: 0.4 },
    { path: '/products/cloud', changeFrequency: 'monthly', priority: 0.4 },
    { path: '/products/studio', changeFrequency: 'monthly', priority: 0.4 },
    { path: '/products/handbook', changeFrequency: 'monthly', priority: 0.4 },
