...
export const BookIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
  ...
  >
    ...
    <path d='M7.75 8.49023H5.5' stroke={color} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
    <path d='M8.5 11.4902H5.5' stroke={color} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
  </svg>
);
