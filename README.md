![Graphical Playground - Engine](https://github.com/GraphicalPlayground/.github/blob/main/assets/banners/gp-platform.svg)
...
If you discover a security vulnerability within `gp-platform`, please do not report
...
`gp-platform` is open-source software. Please see the [LICENSE.md](./LICENSE.md) file in the root
directory for full terms regarding modification, distribution, and use in your own projects.

### Donations

If you find `gp-platform` helpful for your learning, academic research, or game development journey,
...
If you have any questions, suggestions, or want to share your projects built with `gp-platform`, we
